...
import com.pact.healthapp.view.imagepick.utils.SDCardImageLoader;
...
public class PhotoWallAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.view_imagepick_photo_wall_item, null);
            holder = new ViewHolder();

            holder.imageView = (ImageView) convertView.findViewById(R.id.view_imagepick_wallitem_img);
            holder.checkBox = (CheckBox) convertView.findViewById(R.id.view_imagepick_wallitem_cb);
