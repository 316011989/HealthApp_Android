 ...
 *         radio buttons. Checking one radio button that belongs to a radio
 *         group unchecks any previously checked radio button within the same
 *         group.
 *         </p>
 * 
 *         <p>
 *         Intially, all of the radio buttons are unchecked. While it is not
 *         possible to uncheck a particular radio button, the radio group can be
 *         cleared to remove the checked state.
 *         </p>
 * 
 *         <p>
 *         The selection is identified by the unique id of the radio button as
 *         defined in the XML layout file.
 *         </p>
 * 
 *         <p>
 ...
 * 
 */
@TargetApi(Build.VERSION_CODES.ICE_CREAM_SANDWICH) public class MultipleRadioGroup extends LinearLayout {
				...
				public boolean onTouch(View v, MotionEvent event) {
					...
					if (mOnCheckedChangeListener != null) {
						mOnCheckedChangeListener.onCheckedChanged(
								MultipleRadioGroup.this, child.getId());
					}
					return true;
				}
			});
