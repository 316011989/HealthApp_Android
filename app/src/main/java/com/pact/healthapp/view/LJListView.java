 ...
 * 改编自XListView
 * <p/>
 * 这个LJListView继承自RelativeLayout，导致一些ListView的属性没有，如果大家项目中需要用到ListView的一些属性，
 * 请在本类中加入
 * <p/>
 * 示例如下（参见274-276行）： public void setOnItemClickListener(OnItemClickListener
 * listener){ mListView.setOnItemClickListener(listener); }
 * <p/>
...
public class LJListView extends RelativeLayout implements OnScrollListener {
    ...
    private void initWithContext(Context context) {
        ...
        mListView = (ListView) LayoutInflater.from(context).inflate(
                R.layout.view_ljlistview, null);
                    ...
                    default:
                        ...
                        if (mListView.getFirstVisiblePosition() == 0) {
                            ...
                            if (mEnablePullRefresh
                                ...
                                mHeaderView
                                        .setState(LJListViewHeader.STATE_REFRESHING);
        ...
        infoHint = (TextView) LayoutInflater.from(context).inflate(
                R.layout.view_ljlistview_infohint, null);
        LayoutParams para = new LayoutParams(LayoutParams.MATCH_PARENT,
                LayoutParams.WRAP_CONTENT);
        para.setMargins(5, -5, 5, 0);
    ...
    public void onFresh() {
        ...
        resetHeaderHeight();
        int finalHeight = dip2px(context, 60); // XListViewHeader中的高度
