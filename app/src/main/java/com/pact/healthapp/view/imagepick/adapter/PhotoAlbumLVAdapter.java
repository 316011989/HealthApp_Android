    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).
                    inflate(R.layout.view_imagepick_photo_album_lv_item, null);
            holder = new ViewHolder();

            holder.firstImageIV = (ImageView) convertView.findViewById(R.id.view_imagepick_albumitem_img);
            holder.pathNameTV = (TextView) convertView.findViewById(R.id.view_imagepick_albumitem_path);
