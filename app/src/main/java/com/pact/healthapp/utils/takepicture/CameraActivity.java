 ...
 *
 */
package com.pact.healthapp.utils.takepicture;
...
public class CameraActivity extends BaseFragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.utils_takpicture);
        setBackType(1);
...
//                .setType(SurfaceHolder.SURFACE_TYPE_PUSH_BUFFERS);
    ...
    private final class MyPictureCallback implements PictureCallback {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            try {
                ...
                Toast.makeText(getApplicationContext(), R.string.sure,
                        Toast.LENGTH_SHORT).show();
    ...
    public void saveToSDCard(byte[] data) throws IOException {
        ...
        File jpgFile = null;
        try {
            jpgFile = new File(new URI(photoUri.toString()));
...
//			parameters.setPreviewFrameRate(5); // 设置每秒显示4帧
            parameters.setPreviewFpsRange(12, 15);// 设置每秒显示4,5帧
