...
public class PayFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        initView();
        //获取待支付信息
        paynum = ServiceOrderData.paymentOrderNum;
        pay_orderfee = ServiceOrderData.selfPay;
    ...
    private void createWXUnifiedOrder() {
        try {
            ServiceEngin.RequestWithUrl(context, Constants.HOST +
                            "/unifiedOrder", Des3.encode(paynum),
                                ...
                                if (obj.getString("trade_state").equals("SUCCESS")) {
                                    ...
                                    dialog = new CommonDialog(context, 1, "确定", null, new View.OnClickListener() {
                                        ...
                                        public void onClick(View v) {
                                            ...
                                            } else if (ServiceOrderData.operation.equals("voucher")) {
                                                getActivity().finish();
