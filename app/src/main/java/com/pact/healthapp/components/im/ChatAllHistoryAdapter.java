...
public class ChatAllHistoryAdapter extends ArrayAdapter<EMConversation> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		if (convertView == null) {
			convertView = inflater.inflate(R.layout.im_chathistory_item,
					parent, false);
		}
		...
		if (position % 2 == 0) {
			holder.list_item_layout
					.setBackgroundResource(R.drawable.im_chathistory_item_bg);
		} else {
			holder.list_item_layout
					.setBackgroundResource(R.drawable.im_chathistory_item_bg);
		}
		...
		if (isGroup) {
			// 群聊消息，显示群聊头像
			holder.avatar
					.setImageResource(R.drawable.im_chathistory_group_icon);
			...
			holder.name.setText(UserUtils.getUserInfo(context, username)
					.getNick());
		}
		...
		if (conversation.getMsgCount() != 0) {
			...
			holder.time.setText(CommonUtil.convertTime(DateUtils
					.getTimestampString(new Date(lastMessage.getMsgTime()))));
