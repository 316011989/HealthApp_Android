...
import com.pact.healthapp.components.im.applib.CallReceiver;
import com.pact.healthapp.components.im.applib.HXNotifier;
import com.pact.healthapp.components.im.applib.HXNotifier.HXNotificationInfoProvider;
import com.pact.healthapp.components.im.applib.HXSDKHelper;
 ...
 * 
 */
public class NciHXSDKHelper extends HXSDKHelper {

	private static final String TAG = "NciHXSDKHelper";
	...
	protected void onConnectionConflict() {
		...
		CommonDialog dialog = new CommonDialog(appContext, 1, "确定", "",
				new OnClickListener() {
					@Override
					public void onClick(View v) {
						// TODO Auto-generated method stub
						SharedPreferenceUtils sp = new SharedPreferenceUtils();
						String phoneNumber = sp.getLoginInfo(appContext,
								"phoneNumber");
						Intent intent = new Intent(appContext,
								LoginActivity.class);
						intent.putExtra("phoneNumber", phoneNumber);
						sp.clearUserinfo(appContext);
						MyApplication.getInstance().exit();
						appContext.startActivity(intent);
					}
				}, null, null, "您的账号已在其他设备登录,请重新登录");
		dialog.show();
	}
	...
	protected HXSDKModel createModel() {
		return new NciHXSDKModel(appContext);
	}
		...
		return new HXNotifier() {
			public synchronized void onNewMsg(final EMMessage message) {
				...
				if (message.getChatType() == ChatType.Chat) {
					...
					notNotifyIds = ((NciHXSDKModel) hxModel)
							.getDisabledGroups();
				} else {
					chatUsename = message.getTo();
					notNotifyIds = ((NciHXSDKModel) hxModel).getDisabledIds();
				}
	 ...
	 */
	public NciHXSDKModel getModel() {
		return (NciHXSDKModel) hxModel;
	}
	...
	public Map<String, User> getContactList() {
		if (getHXId() != null && contactList == null) {
			contactList = ((NciHXSDKModel) getModel()).getContactList();
		}
