...
import com.pact.healthapp.components.im.applib.LoadLocalBigImgTask;
import com.pact.healthapp.universal.BaseFragmentActivity;
import com.pact.healthapp.view.imageshow.PhotoView;
...
public class ShowBigImage extends BaseFragmentActivity {
	...
	private int default_res = R.mipmap.defalt_pic;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		default_res = getIntent().getIntExtra("default_image", R.mipmap.defalt_pic);
