 ...
 */
package com.pact.healthapp.components.im.applib;
...
import com.pact.healthapp.components.im.NciHXSDKModel;
...
public abstract class HXSDKHelper {
	...
	public synchronized boolean onInit(Context context) {
		...
		// model
		if (hxModel == null) {
			hxModel = new NciHXSDKModel(appContext);
		}
		...
		if (processAppName == null
				|| !processAppName
						.equalsIgnoreCase(hxModel.getAppProcessName())) {
