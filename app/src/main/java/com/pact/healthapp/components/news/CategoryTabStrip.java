...
public class CategoryTabStrip extends HorizontalScrollView {
	...
	public CategoryTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		// 绘制高亮区域作为滑动分页指示器
		indicator = getResources().getDrawable(
				R.drawable.news_category_indicator);
		// 左右边界阴影效果
		// left_edge = getResources().getDrawable(
		// R.drawable.news_category_left_edge);
		// right_edge = getResources().getDrawable(
		// R.drawable.news_category_right_edge);
	}
	...
	private void addTab(final int position, String title) {
		ViewGroup tab = (ViewGroup) mLayoutInflater.inflate(
				R.layout.news_category_tab, this, false);
