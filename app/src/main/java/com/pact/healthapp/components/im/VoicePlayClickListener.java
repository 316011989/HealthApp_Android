...
public class VoicePlayClickListener implements View.OnClickListener {
	...
	public void stopPlayVoice() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView
					.setImageResource(R.drawable.im_chatfrom_voice_playing);
		} else {
			voiceIconView.setImageResource(R.drawable.im_chatto_voice_playing);
		}
		// stop play voice
		if (mediaPlayer != null) {
			mediaPlayer.stop();
	...
	public void playVoice(String filePath) {
		...
		if (NciHXSDKHelper.getInstance().getModel().getSettingMsgSpeaker()) {
	...
	private void showAnimation() {
		...
		if (message.direct == EMMessage.Direct.RECEIVE) {
			voiceIconView.setImageResource(R.drawable.im_voice_from_icon);
		} else {
			voiceIconView.setImageResource(R.drawable.im_voice_to_icon);
		}
